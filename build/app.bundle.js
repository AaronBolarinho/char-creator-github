...
var StupidStatement = function (_React$Component2) {
    _inherits(StupidStatement, _React$Component2);

    function StupidStatement() {
        _classCallCheck(this, StupidStatement);

        return _possibleConstructorReturn(this, (StupidStatement.__proto__ || Object.getPrototypeOf(StupidStatement)).apply(this, arguments));
    }

    _createClass(StupidStatement, [{
        key: 'render',
        value: function render() {
            return React.createElement(
                'p',
    ...
    return StupidStatement;
}(React.Component);

var MainPane = function (_React$Component3) {
    _inherits(MainPane, _React$Component3);

    function MainPane() {
        _classCallCheck(this, MainPane);

        return _possibleConstructorReturn(this, (MainPane.__proto__ || Object.getPrototypeOf(MainPane)).apply(this, arguments));
    }

    _createClass(MainPane, [{
        key: 'render',
        value: function render() {
            var statements = this.props.descriptors.map(function (descriptor) {
                return React.createElement(StupidStatement, { descriptor: descriptor });
            });
            return React.createElement(
                'div',
                null,
...
var App = function (_React$Component4) {
    ...
    _createClass(App, [{
        key: 'render',
        value: function render() {
            var descriptors = ["easy", "fun", "full of semicolons", "good at being associated wih java", "bad at having a loveable package manager"];
            return React.createElement(
                'div',
                null,
                React.createElement(Header, { title: 'Baby\'s first react app' }),
                React.createElement(MainPane, { descriptors: descriptors })
            );
        }
    }]);
